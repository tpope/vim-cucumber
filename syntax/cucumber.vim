...
let g:cucumber_langauges = {
      \"en": {"and": "And", "but": "But", "examples": "Examples", "feature": "Feature", "given": "Given", "scenario": "Scenario", "scenario_outline": "Scenario Outline", "then": "Then", "when": "When"},
      ...
      \"cz": {"and": "A", "but": "Ale", "examples": "P\u0159\u00edklady", "feature": "Po\u017eadavek", "given": "Pokud", "scenario": "Sc\u00e9n\u00e1\u0159", "scenario_outline": "N\u00e1\u010drt Sc\u00e9n\u00e1\u0159e", "then": "Pak", "when": "Kdy\u017e"},
      \"da": {"and": "Og", "but": "Men", "examples": "Eksempler", "feature": "Egenskab", "given": "Givet", "scenario": "Scenarie", "scenario_outline": "Abstrakt Scenario", "then": "S\u00e5", "when": "N\u00e5r"},
      \"de": {"and": "Und", "but": "Aber", "examples": "Beispiele", "feature": "Funktionalit\u00e4t", "given": "Gegeben sei", "scenario": "Szenario", "scenario_outline": "Szenariogrundriss", "then": "Dann", "when": "Wenn"},
      \"en-lol": {"and": "AN", "but": "BUT", "examples": "EXAMPLZ", "feature": "OH HAI", "given": "GIVN", "scenario": "MISHUN", "scenario_outline": "MISHUN SRSLY", "then": "DEN", "when": "WEN"},
      \"es": {"and": "Y", "but": "Pero", "examples": "Ejemplos", "feature": "Caracter\u00edstica", "given": "Dado", "scenario": "Escenario", "scenario_outline": "Esquema del escenario", "then": "Entonces", "when": "Cuando"},
      ...
      \"no": {"and": "Og", "but": "Men", "examples": "Eksempler", "feature": "Egenskap", "given": "Gitt", "scenario": "Scenario", "scenario_outline": "Abstrakt Scenario", "then": "S\u00e5", "when": "N\u00e5r"},
      ...
      \"se": {"and": "Och", "but": "Men", "examples": "Exempel", "feature": "Egenskap", "given": "Givet", "scenario": "Scenario", "scenario_outline": "Abstrakt Scenario", "then": "S\u00e5", "when": "N\u00e4r"},
