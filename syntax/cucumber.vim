...
let g:cucumber_langauges = {
      \"en": {"and": "And", "but": "But", "feature": "Feature", "given": "Given", "more_examples": "More Examples", "scenario": "Scenario", "then": "Then", "when": "When"},
      \"ar": {"and": "\u0648", "but": "\u0644\u0643\u0646", "feature": "\u062e\u0627\u0635\u064a\u0629", "given": "\u0628\u0641\u0631\u0636", "more_examples": "\u0627\u0645\u062b\u0644\u0629 \u0627\u0643\u062b\u0631", "scenario": "\u0633\u064a\u0646\u0627\u0631\u064a\u0648", "then": "\u0627\u0630\u0627\u064b", "when": "\u0645\u062a\u0649"},
      \"cy": {"and": "A", "but": "Ond", "feature": "Arwedd", "given": "anrhegedig a", "more_examples": "Hychwaneg enghreifftiau", "scenario": "Scenario", "then": "Yna", "when": "Pryd"},
      \"da": {"and": "Og", "but": "Men", "feature": "Egenskab", "given": "Givet", "scenario": "Scenarie", "then": "S\u00e5", "when": "N\u00e5r"},
      \"de": {"and": "Und", "but": "Aber", "feature": "Funktionalit\u00e4t", "given": "Gegeben sei", "more_examples": "Mehr Beispiele", "scenario": "Szenario", "then": "Dann", "when": "Wenn"},
      \"es": {"and": "Y", "but": "Pero", "feature": "Caracter\u00edstica", "given": "Dado", "more_examples": "M\u00e1s ejemplos", "scenario": "Escenario", "then": "Entonces", "when": "Cuando"},
      \"et": {"and": "Ja", "but": "Kuid", "feature": "Omadus", "given": "Eeldades", "scenario": "Stsenaarium", "then": "Siis", "when": "Kui"},
      \"fr": {"and": "Et", "but": "Mais", "feature": "Fonction", "given": "Soit", "more_examples": "Plus d'exemples", "scenario": "Scenario", "then": "Alors", "when": "Lorsque"},
      \"id": {"and": "Dan", "but": "Tapi", "feature": "Fitur", "given": "Dengan", "more_examples": "Contoh Tambahan", "scenario": "Skenario", "then": "Maka", "when": "Ketika"},
      ...
      \"lt": {"and": "Ir", "but": "Bet", "feature": "S\u0105vyb\u0117", "given": "Duota", "more_examples": "Daugiau pavyzd\u017ei\u0173", "scenario": "Scenarijus", "then": "Tada", "when": "Kai"},
      \"nl": {"and": "En", "but": "Maar", "feature": "Functionaliteit", "given": "Gegeven", "more_examples": "Meer voorbeelden", "scenario": "Scenario", "then": "Dan", "when": "Als"},
      \"no": {"and": "Og", "but": "Men", "feature": "Egenskap", "given": "Gitt", "more_examples": "Flere eksempler", "scenario": "Scenario", "then": "S\u00e5", "when": "N\u00e5r"},
      \"pl": {"and": "Oraz", "but": "Ale", "feature": "W\u0142a\u015bciwo\u015b\u0107", "given": "Dane", "more_examples": "Wi\u0119cejPrzyk\u0142ad\u00f3w", "scenario": "Scenariusz", "then": "Wtedy", "when": "Je\u017celi"},
      \"pt": {"and": "E", "but": "Mas", "feature": "Caracter\u00edstica", "given": "Dado", "scenario": "Cen\u00e1rio", "then": "Ent\u00e3o", "when": "Quando"},
      \"ro": {"and": "Si", "but": "Dar", "feature": "Functionalitate", "given": "Daca", "more_examples": "Mai multe exemple", "scenario": "Scenariu", "then": "Atunci", "when": "Cand"},
      \"ro2": {"and": "\u0218i", "but": "Dar", "feature": "Func\u021bionalitate", "given": "Dac\u0103", "more_examples": "Mai multe exemple", "scenario": "Scenariu", "then": "Atunci", "when": "C\u00e2nd"},
      \"ru": {"and": "\u0418", "but": "\u041d\u043e", "feature": "\u0424\u0443\u043d\u043a\u0446\u0438\u043e\u043d\u0430\u043b", "given": "\u0421\u043d\u0430\u0447\u0430\u043b\u0430", "scenario": "\u0421\u0446\u0435\u043d\u0430\u0440\u0438\u0439", "then": "\u0422\u043e", "when": "\u0415\u0441\u043b\u0438"},
      \"se": {"and": "Och", "but": "Men", "feature": "Egenskap", "given": "Givet", "scenario": "Scenario", "then": "S\u00e5", "when": "N\u00e4r"},
